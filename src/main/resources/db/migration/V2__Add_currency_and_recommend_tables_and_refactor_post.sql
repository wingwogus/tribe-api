...
(
    ...
    CONSTRAINT `PRIMARY` PRIMARY KEY (cur_unit, date)
);

-- 3. (신규) recommended_place 테이블 생성
...
-- 5. community_post 새 외래 키 및 인덱스 추가
ALTER TABLE community_post
...
-- 6. recommended_place 새 외래 키 추가 (인덱스는 자동 생성됨)
